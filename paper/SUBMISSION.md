...
| Build | Pages | Notes |
|-------|------:|-------|
| **Local `make paper` / latexmk** (this polish draft) | **9** | Body + appendix fit through p8; bibliography starts p8 and spills ~6 lines onto p9 |
...
|-------------|--------------|
| 6 pages (+1 refs often) | Still over; further trim only after §0 page limit is known — do not invent results to fill or cut honesty |
| 8 pages (+ refs / inclusive) | Within reach: ≈8pp body+appendix; refs spill is small |
...
|------|--------------|--------------|
| Main body | **6–8 pages** | Living draft trimmed (related-work density, duplicate pin prose, compact reserved `tab:placeholder`); Discussion owns green×8×3 vs RQ N/A |
...
| License / README | `LICENSE`, `README.md` | **yes** |
